...
def filter_words(words, skip_words):
    ...
    """
    """i = ' '.join(filter(lambda x: x.lower() if words not in skip_words))
    i.split()
    print(i)"""
    """resultwords  = [word for word in re.split("\W+",words) if word not in skip_words]
...
def normalise_input(user_input):
    ...
    return(user_input.translate(remove_punct).lower().strip())
